...
<!--                                         :establishment="establishment">-->
<!--                            </header-form>-->
<!--&lt;!&ndash;                            <address class="ib mr-2">&ndash;&gt;-->
<!--&lt;!&ndash;                                <span class="font-weight-bold d-block">COTIZACIÓN</span>&ndash;&gt;-->
<!--&lt;!&ndash;                                <span class="font-weight-bold d-block">COT-XXX</span>&ndash;&gt;-->
<!--&lt;!&ndash;                                <span class="font-weight-bold">{{ company.name }}</span>&ndash;&gt;-->
<!--&lt;!&ndash;                                <template v-if="establishment.address !== ''">&ndash;&gt;-->
<!--&lt;!&ndash;                                    <br>&ndash;&gt;-->
<!--&lt;!&ndash;                                    <span>{{ establishment.address }}</span>&ndash;&gt;-->
<!--&lt;!&ndash;                                </template>&ndash;&gt;-->
<!--&lt;!&ndash;                                <template v-if="establishment.email !== ''">&ndash;&gt;-->
<!--&lt;!&ndash;                                    <br>&ndash;&gt;-->
<!--&lt;!&ndash;                                    <span>{{ establishment.email }}</span>&ndash;&gt;-->
<!--&lt;!&ndash;                                </template>&ndash;&gt;-->
<!--&lt;!&ndash;                                <template v-if="establishment.telephone !== ''">&ndash;&gt;-->
<!--&lt;!&ndash;                                    <br>&ndash;&gt;-->
<!--&lt;!&ndash;                                    <span>{{ establishment.telephone }}</span>&ndash;&gt;-->
<!--&lt;!&ndash;                                </template>&ndash;&gt;-->
<!--&lt;!&ndash;                            </address>&ndash;&gt;-->
<!--                        </div>-->
<!--                    </div>-->
